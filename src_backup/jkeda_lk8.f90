    ...
    do ibas = ifi,ils
       ...
       !         LL = natm + 1
             ...
             !  tem = body2(a,b,c,d,natm,m,II,JJ,KK,LL)
                  ...
                  atom_ej(II) = atom_ej(II) + e_coul
                  atom_ej(JJ) = atom_ej(JJ) + e_coul
                  atom_ej(KK) = atom_ej(KK) + e_coul
                  atom_ej(LL) = atom_ej(LL) + e_coul
         ...
         do kbas = kfi,kls
            ...
            do j =1,nao 
               ...
               !  tem = body2(a,b,c,d,natm,m,II,JJ,KK,LL)
                   ...
                   e_coul = e_coul/m 
                   atom_ek(II) = atom_ek(II) + e_coul
                   atom_ek(JJ) = atom_ek(JJ) + e_coul
                   atom_ek(KK) = atom_ek(KK) + e_coul
                   atom_ek(LL) = atom_ek(LL) + e_coul
               endif
          enddo
        enddo
      enddo

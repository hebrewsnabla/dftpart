...
subroutine bgh1e_inter(dm,bas2atm,bas2frg, vchg_frag,natm,nao,nfrag,nbgfrag,energy_ebg, bg_2, bg_3)
implicit none
...
!integer atm2frg(natm)
real*8 dm(nao,nao)
real*8 vchg_frag(nbgfrag,nao,nao)
real*8 energy_ebg(natm)
!real*8 e1_1(nfrag)
real*8 bg_2(nfrag,nfrag)
real*8 bg_3(nfrag,nfrag,nfrag)
!real*8 e1_3(natm,natm,natm)
real*8 tem
real*8 H1E_THRESH
